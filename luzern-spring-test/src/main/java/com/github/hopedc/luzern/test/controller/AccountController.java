...
//import com.github.hopedc.luzern.test.vo.Account;
//
...
//
//    /**
//     * 获取当前登录用户的账户资产信息,用户不存在会返回code为9999的错误信息,见:https://github.com/treehopedcj/luzern
//     *
//     * @param type 账户类型(1-普通账户)|必填
//     * @return 用户的资产
//     * @title 查询用户资产
//     * @see com.github.hopedc.luzern.test.vo.AccountEx
//     */
//    @ResponseBody
